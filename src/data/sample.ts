...
export const sampleData: FeatureCollection = { type: 'FeatureCollection', features: [
  { type: 'Feature', properties: { id: 'modern-koshu', name: '甲州街道（現代・サンプル）', type: 'road', aliases: ['国道20号', '新宿通り'], ...meta }, geometry: { type: 'LineString', coordinates: [[139.7214,35.6848],[139.7101,35.6887],[139.7005,35.6896],[139.6891,35.6833],[139.6765,35.6785]] } },
