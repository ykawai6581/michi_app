...
describe('project-backed scene items', () => {
  it('seeds every project road and excludes other project entities', () => {
  ...
  it('does not duplicate project roads when refreshed', () => {
    ...
    expect(seedProjectRoads([road], first)).toEqual([{ feature: road, visible: false, projectBacked: true }])
  })
