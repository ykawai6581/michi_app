...
export const initialLayerVisibility=():LayerVisibility=>({basemap:'presentation',darkBasemap:false,modernRoads:true,railways:false,stations:false,historicalRoads:true,historicalPosts:true})
