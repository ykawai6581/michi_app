...
export function addDataLayers(map: maplibregl.Map, project: ProjectData): void {
  ...
  map.addLayer({ id: LAYER_IDS.highlightLineActive, type: 'line', source: SOURCE_IDS.highlight, filter: activeLineFilter, layout: { 'line-cap':'round','line-join':'round' }, paint: { 'line-color':lineColorExpression(ROAD_LABEL_COLOR,HISTORICAL_ROAD_LABEL_COLOR),'line-width':activeCoreWidth,'line-opacity':1 } })
