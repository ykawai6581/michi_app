...
export function addDataLayers(map: maplibregl.Map, project: ProjectData): void {
  ...
  map.addLayer({id:LAYER_IDS.jurisdictionHighlightFill,type:'fill',source:SOURCE_IDS.jurisdictionHighlight,paint:{'fill-color':'#f0b174','fill-opacity':0}})
  map.addLayer({id:LAYER_IDS.jurisdictionHighlightGlow,type:'line',source:SOURCE_IDS.jurisdictionHighlight,paint:{'line-color':'#e96d32','line-width':17,'line-blur':7,'line-opacity':0}})
  map.addLayer({id:LAYER_IDS.jurisdictionHighlightLine,type:'line',source:SOURCE_IDS.jurisdictionHighlight,paint:{'line-color':'#e96d32','line-width':4,'line-opacity':0}})
  map.addLayer({id:LAYER_IDS.jurisdictionHighlightLabel,type:'symbol',source:SOURCE_IDS.jurisdictionHighlight,filter:['==',['get','emphasisLabel'],true],layout:{'text-field':['format',['case',['has','parent'],['concat',['get','parent'],'\n'],''],{'font-scale':0.7},['get','primary'],{'font-scale':1}],'text-size':28,'text-font':['Noto Sans Regular'],'text-anchor':'center','text-allow-overlap':true},paint:{'text-color':'#fff7e8','text-halo-color':'#06151d','text-halo-width':0,'text-opacity':0}})
