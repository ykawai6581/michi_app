...
import { DEFAULT_HIGHLIGHT_STYLE, JURISDICTION_HIGHLIGHT_COLOR, REGION_HIGHLIGHT_COLOR, ROAD_LABEL_COLOR, SHUKUBA_LABEL_COLOR, STATION_LABEL_COLOR } from './highlightDefaults'
