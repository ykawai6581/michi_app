...
import { fitVisibleScene, sceneBounds, sceneFitPadding } from './sceneFit'
...
const line = (id: string, coordinates: [number,number][], name=id): EntityFeature => ({ type:'Feature', properties:{id,name,type:'road'}, geometry:{type:'LineString',coordinates} })
