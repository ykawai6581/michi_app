...
try: write_snapshot(args.input, args.output, prefecture=args.prefecture, prefecture_name=args.prefecture_name, snapshot_date=args.snapshot_date, topology_object=args.topology_object)
