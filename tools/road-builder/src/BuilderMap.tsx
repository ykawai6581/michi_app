...
type PreviewLayer=ProjectLayer|'locations'
const ids:PreviewLayer[]=['modernRoads','railways','stations','historicalRoads','historicalPosts','locations']
const definitions:Record<PreviewLayer,{type:'line'|'circle';paint:object}>={
...
export default function BuilderMap({layers,visibility,bounds,onFeature}:{layers:Partial<Record<PreviewLayer,FC>>;visibility:ProjectVisibility;bounds?:[number,number,number,number];onFeature:(properties:object)=>void}){
