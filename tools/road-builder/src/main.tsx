...
type MatchPreviewResult={previewId:string;draftHash:string;reference:FC;referenceExcluded:FC;autoSelected:FC;autoSelectedSourceAtoms:FC;selectedSubstrings:FC;unselectedShortlist:FC;allCandidates:FC;residualRejected:FC;diagnostics:FC;ownership:FC}
...
function App(){
  ...
  const displayedLayers=useMemo<DiagnosticLayers>(()=>{
    ...
    if(layers.autoSelected&&layers.autoSelectedSourceAtoms&&layers.unselectedShortlist){
      const review=deriveManualReviewLayers({autoSelected:layers.autoSelected,autoSelectedSourceAtoms:layers.autoSelectedSourceAtoms,unselectedShortlist:layers.unselectedShortlist},manualSelection)
