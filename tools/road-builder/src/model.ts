export type Road={id:string;displayName:string;entityType:'named-road'|'statutory-road';jurisdiction:string;aliases:string[];reference:{type:string;names?:string[];tags?:string[];ref?:string;[key:string]:unknown};n13:{classifications:string[]};matching:Record<string,number>;networkSelection?:Record<string,number>;[key:string]:unknown}
