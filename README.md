...
標準地図は国土地理院のオンラインタイルを利用します。そのため、ベースマップの初回表示にはインターネット接続が必要です。歴史街道、宿場、町丁目のoverlayは引き続き手描きsampleであり、実データと明確に区別しています。
...
- 現代ベースマップは国土地理院のオンライン標準地図です。offline時は白い背景と同梱sampleだけが表示されます。
